...
<?php
    try
    {
        ...
        $artisteinterprete = $row["artisteinterprete"];
        $artistecompositeur = $row["artistecompositeur"];
        $artisteconducteur = $row["artisteconducteur"];
        }   
