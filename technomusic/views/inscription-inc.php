        ...
        <form class="form-horizontal" enctype="multipart/form-data" action="?" method="post" name="inscription">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input class="form-control"  name="password" placeholder="Entrez un mot de passe" type="password">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label">Mot de passe</label>
                    <div class="col-lg-10">
                        <input class="form-control" name="password1" placeholder="réintroduisez le mot de passe" type="password">
                    </div>
                </div>
